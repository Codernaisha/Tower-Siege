...
function setup() {
 ...
 //stack 2
 Block6 = new Block(670,125,30,40);
 Block7 = new Block(700,125,30,40);
 Block8 = new Block(730,125,30,40);

 //top
 SpecialBlock = new Block(700,75,30,40);
...
function draw() {
  ...
  textSize(20);
  fill("lightyellow");
  text("Drag the hexagon and release it to knock down the enemy towers",140,40);
